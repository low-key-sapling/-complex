 ...
 * 长连接
 */
public class RpcLongConnectServer extends Thread {
    //16进制数字字符集
    ...
    public RpcLongConnectServer(Socket socket) {
    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                RpcLongConnectServer thread = new RpcLongConnectServer(socket);
                thread.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
