...
public class NetworkMusicPlayer {
    ...
    static final String rankSongListUrl = "https://m.kugou.com/rank/info/?rankid=8888&page=1&json=true";
    ...
    private static List<String> getSongIdList(int page) throws Exception {
        ...
        //酷狗获取音乐排行榜
        String hotUrl = "http://m.kugou.com/rank/info/?rankid=8888&page=" + page + "&json=true";
        String post = httpClientUtil.post(hotUrl);
